...
from apps.user.views import BlockUserView, UnBlockUserView, UserListCreateView, UserSendEmailTestView, UserToAdminView
...
urlpatterns = [
    ...
    path('/test', UserSendEmailTestView.as_view(), name='send_email_test'),
]